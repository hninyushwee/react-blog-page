        ...
        >
          <div className="flex justify-center pt-8 mb-2 sm:mb-3 md:mb-3 lg:mb-3">
            <input
              ...
              className="text-[#374151] text-sm md:text-base lg:text-base py-0.5 md:py-1 lg:py-1 px-5 rounded md:rounded-md lg:rounded-md border border-amber-800 border-y-amber-800 focus:outline-none shadow-lg"
            />
          </div>
          <select
            value={filterItem}
