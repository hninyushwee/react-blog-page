...
function Navbar() {
  ...
  return (
    <nav
      className="bg-black flex flex-row justify-between w-full py-1 lg:py-1.5 px-5 border-b border-[#9ca3afa1] font-bold text-slate-400 fixed"
      style={
    ...
    >
      ...
      <div className="flex items-center text-[11px] sm:text-sm md:text-sm lg:text-base">
        <NavLink
          to="/"
        ...
        <div className="px-1.5 py-[2px] sm:px-2 sm:py-[4px] md:px-2.5 md:py-[4px] lg:px-3 lg:py-[6px] flex hover:text-blue-400">
          <button onClick={handleTheme}>
            {!theme.click ? (
              ...
              <MoonIcon className="w:4 h:4 sm:w-4 sm:h-5 md:w-5 md:h-5 lg:w-6 lg:h-6" />
            )}
          </button>
        </div>
        {userDetails ? (
